...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseOrderTransactionList();
  });
  ...
  describe('ModelResponseOrderTransactionList', function() {
    it('should create an instance of ModelResponseOrderTransactionList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseOrderTransactionList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseOrderTransactionList);
    });
