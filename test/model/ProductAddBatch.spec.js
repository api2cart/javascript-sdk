...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductAddBatch();
  });
  ...
  describe('ProductAddBatch', function() {
    it('should create an instance of ProductAddBatch', function() {
      // uncomment below and update the code to test ProductAddBatch
      //var instance = new Api2CartOpenApi.ProductAddBatch();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductAddBatch);
    });
