...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductVariantDeleteBatch();
  });
  ...
  describe('ProductVariantDeleteBatch', function() {
    it('should create an instance of ProductVariantDeleteBatch', function() {
      // uncomment below and update the code to test ProductVariantDeleteBatch
      //var instance = new Api2CartOpenApi.ProductVariantDeleteBatch();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductVariantDeleteBatch);
    });
