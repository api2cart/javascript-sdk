...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductGroupPrice();
  });
  ...
  describe('ProductGroupPrice', function() {
    it('should create an instance of ProductGroupPrice', function() {
      ...
      //var instance = new Api2CartOpenApi.ProductGroupPrice();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductGroupPrice);
    });
