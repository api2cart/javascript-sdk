...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseAttributeGroupList();
  });
  ...
  describe('ModelResponseAttributeGroupList', function() {
    it('should create an instance of ModelResponseAttributeGroupList', function() {
      // uncomment below and update the code to test ModelResponseAttributeGroupList
      //var instance = new Api2CartOpenApi.ModelResponseAttributeGroupList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseAttributeGroupList);
    });
