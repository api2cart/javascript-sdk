...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductChildItemListResult();
  });
  ...
  describe('ResponseProductChildItemListResult', function() {
    it('should create an instance of ResponseProductChildItemListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseProductChildItemListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductChildItemListResult);
    });
