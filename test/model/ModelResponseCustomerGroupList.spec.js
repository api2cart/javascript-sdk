...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCustomerGroupList();
  });
  ...
  describe('ModelResponseCustomerGroupList', function() {
    it('should create an instance of ModelResponseCustomerGroupList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCustomerGroupList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCustomerGroupList);
    });
