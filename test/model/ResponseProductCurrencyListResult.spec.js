...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductCurrencyListResult();
  });
  ...
  describe('ResponseProductCurrencyListResult', function() {
    it('should create an instance of ResponseProductCurrencyListResult', function() {
      // uncomment below and update the code to test ResponseProductCurrencyListResult
      //var instance = new Api2CartOpenApi.ResponseProductCurrencyListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductCurrencyListResult);
    });
