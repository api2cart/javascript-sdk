...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseBatchJobResult();
  });
  ...
  describe('ResponseBatchJobResult', function() {
    it('should create an instance of ResponseBatchJobResult', function() {
      // uncomment below and update the code to test ResponseBatchJobResult
      //var instance = new Api2CartOpenApi.ResponseBatchJobResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseBatchJobResult);
    });
