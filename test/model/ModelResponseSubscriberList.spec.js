...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseSubscriberList();
  });
  ...
  describe('ModelResponseSubscriberList', function() {
    it('should create an instance of ModelResponseSubscriberList', function() {
      // uncomment below and update the code to test ModelResponseSubscriberList
      //var instance = new Api2CartOpenApi.ModelResponseSubscriberList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseSubscriberList);
    });
