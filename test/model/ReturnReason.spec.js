...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ReturnReason();
  });
  ...
  describe('ReturnReason', function() {
    it('should create an instance of ReturnReason', function() {
      // uncomment below and update the code to test ReturnReason
      //var instance = new Api2CartOpenApi.ReturnReason();
      //expect(instance).to.be.a(Api2CartOpenApi.ReturnReason);
    });
