...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductVariantUpdateBatchPayloadInner();
  });
  ...
  describe('ProductVariantUpdateBatchPayloadInner', function() {
    it('should create an instance of ProductVariantUpdateBatchPayloadInner', function() {
      // uncomment below and update the code to test ProductVariantUpdateBatchPayloadInner
      //var instance = new Api2CartOpenApi.ProductVariantUpdateBatchPayloadInner();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductVariantUpdateBatchPayloadInner);
    });
    ...
    it('should have the property productImagesIds (base name: "product_images_ids")', function() {
      // uncomment below and update the code to test the property productImagesIds
      //var instance = new Api2CartOpenApi.ProductVariantUpdateBatchPayloadInner();
      //expect(instance).to.be();
    });
