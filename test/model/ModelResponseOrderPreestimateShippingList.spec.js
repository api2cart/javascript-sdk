...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseOrderPreestimateShippingList();
  });
  ...
  describe('ModelResponseOrderPreestimateShippingList', function() {
    it('should create an instance of ModelResponseOrderPreestimateShippingList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseOrderPreestimateShippingList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseOrderPreestimateShippingList);
    });
