...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseSubscriberListResult();
  });
  ...
  describe('ResponseSubscriberListResult', function() {
    it('should create an instance of ResponseSubscriberListResult', function() {
      // uncomment below and update the code to test ResponseSubscriberListResult
      //var instance = new Api2CartOpenApi.ResponseSubscriberListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseSubscriberListResult);
    });
