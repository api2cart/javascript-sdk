...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductOptionListResult();
  });
  ...
  describe('ResponseProductOptionListResult', function() {
    it('should create an instance of ResponseProductOptionListResult', function() {
      // uncomment below and update the code to test ResponseProductOptionListResult
      //var instance = new Api2CartOpenApi.ResponseProductOptionListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductOptionListResult);
    });
