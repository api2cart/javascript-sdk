...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.CustomerAttribute();
  });
  ...
  describe('CustomerAttribute', function() {
    it('should create an instance of CustomerAttribute', function() {
      ...
      //var instance = new Api2CartOpenApi.CustomerAttribute();
      //expect(instance).to.be.a(Api2CartOpenApi.CustomerAttribute);
    });
