...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseBatchJobList();
  });
  ...
  describe('ModelResponseBatchJobList', function() {
    it('should create an instance of ModelResponseBatchJobList', function() {
      // uncomment below and update the code to test ModelResponseBatchJobList
      //var instance = new Api2CartOpenApi.ModelResponseBatchJobList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseBatchJobList);
    });
