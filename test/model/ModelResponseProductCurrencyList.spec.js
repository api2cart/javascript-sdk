...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductCurrencyList();
  });
  ...
  describe('ModelResponseProductCurrencyList', function() {
    it('should create an instance of ModelResponseProductCurrencyList', function() {
      // uncomment below and update the code to test ModelResponseProductCurrencyList
      //var instance = new Api2CartOpenApi.ModelResponseProductCurrencyList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductCurrencyList);
    });
