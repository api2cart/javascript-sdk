...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseOrderList();
  });
  ...
  describe('ModelResponseOrderList', function() {
    it('should create an instance of ModelResponseOrderList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseOrderList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseOrderList);
    });
