...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseOrderShipmentList();
  });
  ...
  describe('ModelResponseOrderShipmentList', function() {
    it('should create an instance of ModelResponseOrderShipmentList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseOrderShipmentList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseOrderShipmentList);
    });
