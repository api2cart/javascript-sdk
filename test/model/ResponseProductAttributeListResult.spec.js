...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductAttributeListResult();
  });
  ...
  describe('ResponseProductAttributeListResult', function() {
    it('should create an instance of ResponseProductAttributeListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseProductAttributeListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductAttributeListResult);
    });
