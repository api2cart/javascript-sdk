...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.AccountCartAddHybrisWebsitesInner();
  });
  ...
  describe('AccountCartAddHybrisWebsitesInner', function() {
    it('should create an instance of AccountCartAddHybrisWebsitesInner', function() {
      ...
      //var instance = new Api2CartOpenApi.AccountCartAddHybrisWebsitesInner();
      //expect(instance).to.be.a(Api2CartOpenApi.AccountCartAddHybrisWebsitesInner);
    });
