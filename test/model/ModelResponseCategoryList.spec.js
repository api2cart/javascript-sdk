...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCategoryList();
  });
  ...
  describe('ModelResponseCategoryList', function() {
    it('should create an instance of ModelResponseCategoryList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCategoryList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCategoryList);
    });
