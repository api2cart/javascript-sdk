...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.BasketLiveShippingService();
  });
  ...
  describe('BasketLiveShippingService', function() {
    it('should create an instance of BasketLiveShippingService', function() {
      ...
      //var instance = new Api2CartOpenApi.BasketLiveShippingService();
      //expect(instance).to.be.a(Api2CartOpenApi.BasketLiveShippingService);
    });
