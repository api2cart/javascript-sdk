...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseReturnList();
  });
  ...
  describe('ModelResponseReturnList', function() {
    it('should create an instance of ModelResponseReturnList', function() {
      // uncomment below and update the code to test ModelResponseReturnList
      //var instance = new Api2CartOpenApi.ModelResponseReturnList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseReturnList);
    });
