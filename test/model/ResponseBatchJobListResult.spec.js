...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseBatchJobListResult();
  });
  ...
  describe('ResponseBatchJobListResult', function() {
    it('should create an instance of ResponseBatchJobListResult', function() {
      // uncomment below and update the code to test ResponseBatchJobListResult
      //var instance = new Api2CartOpenApi.ResponseBatchJobListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseBatchJobListResult);
    });
