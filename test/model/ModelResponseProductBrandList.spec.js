...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductBrandList();
  });
  ...
  describe('ModelResponseProductBrandList', function() {
    it('should create an instance of ModelResponseProductBrandList', function() {
      // uncomment below and update the code to test ModelResponseProductBrandList
      //var instance = new Api2CartOpenApi.ModelResponseProductBrandList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductBrandList);
    });
