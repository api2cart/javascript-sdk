...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ShipmentTrackingNumber();
  });
  ...
  describe('ShipmentTrackingNumber', function() {
    it('should create an instance of ShipmentTrackingNumber', function() {
      ...
      //var instance = new Api2CartOpenApi.ShipmentTrackingNumber();
      //expect(instance).to.be.a(Api2CartOpenApi.ShipmentTrackingNumber);
    });
