...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductAddBatchPayloadInner();
  });
  ...
  describe('ProductAddBatchPayloadInner', function() {
    it('should create an instance of ProductAddBatchPayloadInner', function() {
      // uncomment below and update the code to test ProductAddBatchPayloadInner
      //var instance = new Api2CartOpenApi.ProductAddBatchPayloadInner();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductAddBatchPayloadInner);
    });
