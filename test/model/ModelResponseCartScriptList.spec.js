...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCartScriptList();
  });
  ...
  describe('ModelResponseCartScriptList', function() {
    it('should create an instance of ModelResponseCartScriptList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCartScriptList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCartScriptList);
    });
