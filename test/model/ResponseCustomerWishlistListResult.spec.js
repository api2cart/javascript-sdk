...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseCustomerWishlistListResult();
  });
  ...
  describe('ResponseCustomerWishlistListResult', function() {
    it('should create an instance of ResponseCustomerWishlistListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseCustomerWishlistListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseCustomerWishlistListResult);
    });
