...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductChildItemList();
  });
  ...
  describe('ModelResponseProductChildItemList', function() {
    it('should create an instance of ModelResponseProductChildItemList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseProductChildItemList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductChildItemList);
    });
