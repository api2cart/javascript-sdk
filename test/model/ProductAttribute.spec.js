...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductAttribute();
  });
  ...
  describe('ProductAttribute', function() {
    it('should create an instance of ProductAttribute', function() {
      ...
      //var instance = new Api2CartOpenApi.ProductAttribute();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductAttribute);
    });
