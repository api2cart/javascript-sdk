...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ReturnAction();
  });
  ...
  describe('ReturnAction', function() {
    it('should create an instance of ReturnAction', function() {
      // uncomment below and update the code to test ReturnAction
      //var instance = new Api2CartOpenApi.ReturnAction();
      //expect(instance).to.be.a(Api2CartOpenApi.ReturnAction);
    });
