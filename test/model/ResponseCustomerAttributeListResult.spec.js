...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseCustomerAttributeListResult();
  });
  ...
  describe('ResponseCustomerAttributeListResult', function() {
    it('should create an instance of ResponseCustomerAttributeListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseCustomerAttributeListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseCustomerAttributeListResult);
    });
