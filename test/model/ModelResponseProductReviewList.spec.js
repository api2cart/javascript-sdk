...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductReviewList();
  });
  ...
  describe('ModelResponseProductReviewList', function() {
    it('should create an instance of ModelResponseProductReviewList', function() {
      // uncomment below and update the code to test ModelResponseProductReviewList
      //var instance = new Api2CartOpenApi.ModelResponseProductReviewList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductReviewList);
    });
