...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseCartMetaDataListResult();
  });
  ...
  describe('ResponseCartMetaDataListResult', function() {
    it('should create an instance of ResponseCartMetaDataListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseCartMetaDataListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseCartMetaDataListResult);
    });
