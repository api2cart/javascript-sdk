...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCartCatalogPriceRulesList();
  });
  ...
  describe('ModelResponseCartCatalogPriceRulesList', function() {
    it('should create an instance of ModelResponseCartCatalogPriceRulesList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCartCatalogPriceRulesList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCartCatalogPriceRulesList);
    });
