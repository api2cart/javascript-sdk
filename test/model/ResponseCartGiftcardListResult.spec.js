...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseCartGiftcardListResult();
  });
  ...
  describe('ResponseCartGiftcardListResult', function() {
    it('should create an instance of ResponseCartGiftcardListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseCartGiftcardListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseCartGiftcardListResult);
    });
