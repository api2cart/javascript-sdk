...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseOrderAbandonedList();
  });
  ...
  describe('ModelResponseOrderAbandonedList', function() {
    it('should create an instance of ModelResponseOrderAbandonedList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseOrderAbandonedList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseOrderAbandonedList);
    });
