...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductList();
  });
  ...
  describe('ModelResponseProductList', function() {
    it('should create an instance of ModelResponseProductList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseProductList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductList);
    });
