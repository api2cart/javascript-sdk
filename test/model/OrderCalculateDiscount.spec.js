...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.OrderCalculateDiscount();
  });
  ...
  describe('OrderCalculateDiscount', function() {
    it('should create an instance of OrderCalculateDiscount', function() {
      // uncomment below and update the code to test OrderCalculateDiscount
      //var instance = new Api2CartOpenApi.OrderCalculateDiscount();
      //expect(instance).to.be.a(Api2CartOpenApi.OrderCalculateDiscount);
    });
