...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.OrderStatusHistoryItem();
  });
  ...
  describe('OrderStatusHistoryItem', function() {
    it('should create an instance of OrderStatusHistoryItem', function() {
      ...
      //var instance = new Api2CartOpenApi.OrderStatusHistoryItem();
      //expect(instance).to.be.a(Api2CartOpenApi.OrderStatusHistoryItem);
    });
