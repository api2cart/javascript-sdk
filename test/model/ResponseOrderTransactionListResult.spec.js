...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseOrderTransactionListResult();
  });
  ...
  describe('ResponseOrderTransactionListResult', function() {
    it('should create an instance of ResponseOrderTransactionListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseOrderTransactionListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseOrderTransactionListResult);
    });
