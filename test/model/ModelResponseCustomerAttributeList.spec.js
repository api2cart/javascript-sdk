...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCustomerAttributeList();
  });
  ...
  describe('ModelResponseCustomerAttributeList', function() {
    it('should create an instance of ModelResponseCustomerAttributeList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCustomerAttributeList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCustomerAttributeList);
    });
