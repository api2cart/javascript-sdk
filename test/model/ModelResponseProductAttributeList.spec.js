...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductAttributeList();
  });
  ...
  describe('ModelResponseProductAttributeList', function() {
    it('should create an instance of ModelResponseProductAttributeList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseProductAttributeList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductAttributeList);
    });
