...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseAttributeList();
  });
  ...
  describe('ModelResponseAttributeList', function() {
    it('should create an instance of ModelResponseAttributeList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseAttributeList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseAttributeList);
    });
