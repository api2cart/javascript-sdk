...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseTaxClassInfoResult();
  });
  ...
  describe('ResponseTaxClassInfoResult', function() {
    it('should create an instance of ResponseTaxClassInfoResult', function() {
      // uncomment below and update the code to test ResponseTaxClassInfoResult
      //var instance = new Api2CartOpenApi.ResponseTaxClassInfoResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseTaxClassInfoResult);
    });
