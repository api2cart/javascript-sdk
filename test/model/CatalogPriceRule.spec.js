...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.CatalogPriceRule();
  });
  ...
  describe('CatalogPriceRule', function() {
    it('should create an instance of CatalogPriceRule', function() {
      ...
      //var instance = new Api2CartOpenApi.CatalogPriceRule();
      //expect(instance).to.be.a(Api2CartOpenApi.CatalogPriceRule);
    });
