...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseTaxClassInfo();
  });
  ...
  describe('ModelResponseTaxClassInfo', function() {
    it('should create an instance of ModelResponseTaxClassInfo', function() {
      // uncomment below and update the code to test ModelResponseTaxClassInfo
      //var instance = new Api2CartOpenApi.ModelResponseTaxClassInfo();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseTaxClassInfo);
    });
