...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductPriceUpdate();
  });
  ...
  describe('ProductPriceUpdate', function() {
    it('should create an instance of ProductPriceUpdate', function() {
      ...
      //var instance = new Api2CartOpenApi.ProductPriceUpdate();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductPriceUpdate);
    });
