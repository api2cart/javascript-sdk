...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.CustomerWishListItem();
  });
  ...
  describe('CustomerWishListItem', function() {
    it('should create an instance of CustomerWishListItem', function() {
      ...
      //var instance = new Api2CartOpenApi.CustomerWishListItem();
      //expect(instance).to.be.a(Api2CartOpenApi.CustomerWishListItem);
    });
