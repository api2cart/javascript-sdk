...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseTaxClassList();
  });
  ...
  describe('ModelResponseTaxClassList', function() {
    it('should create an instance of ModelResponseTaxClassList', function() {
      // uncomment below and update the code to test ModelResponseTaxClassList
      //var instance = new Api2CartOpenApi.ModelResponseTaxClassList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseTaxClassList);
    });
