...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductInventory();
  });
  ...
  describe('ProductInventory', function() {
    it('should create an instance of ProductInventory', function() {
      ...
      //var instance = new Api2CartOpenApi.ProductInventory();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductInventory);
    });
