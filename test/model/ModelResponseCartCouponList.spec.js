...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCartCouponList();
  });
  ...
  describe('ModelResponseCartCouponList', function() {
    it('should create an instance of ModelResponseCartCouponList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCartCouponList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCartCouponList);
    });
