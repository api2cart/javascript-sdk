...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.OrderStatusRefund();
  });
  ...
  describe('OrderStatusRefund', function() {
    it('should create an instance of OrderStatusRefund', function() {
      ...
      //var instance = new Api2CartOpenApi.OrderStatusRefund();
      //expect(instance).to.be.a(Api2CartOpenApi.OrderStatusRefund);
    });
