...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseAttributeAttributesetList();
  });
  ...
  describe('ModelResponseAttributeAttributesetList', function() {
    it('should create an instance of ModelResponseAttributeAttributesetList', function() {
      // uncomment below and update the code to test ModelResponseAttributeAttributesetList
      //var instance = new Api2CartOpenApi.ModelResponseAttributeAttributesetList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseAttributeAttributesetList);
    });
