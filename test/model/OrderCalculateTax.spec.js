...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.OrderCalculateTax();
  });
  ...
  describe('OrderCalculateTax', function() {
    it('should create an instance of OrderCalculateTax', function() {
      // uncomment below and update the code to test OrderCalculateTax
      //var instance = new Api2CartOpenApi.OrderCalculateTax();
      //expect(instance).to.be.a(Api2CartOpenApi.OrderCalculateTax);
    });
