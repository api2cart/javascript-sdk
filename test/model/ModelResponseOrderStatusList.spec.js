...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseOrderStatusList();
  });
  ...
  describe('ModelResponseOrderStatusList', function() {
    it('should create an instance of ModelResponseOrderStatusList', function() {
      // uncomment below and update the code to test ModelResponseOrderStatusList
      //var instance = new Api2CartOpenApi.ModelResponseOrderStatusList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseOrderStatusList);
    });
