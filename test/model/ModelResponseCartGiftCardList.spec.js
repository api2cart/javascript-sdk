...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCartGiftCardList();
  });
  ...
  describe('ModelResponseCartGiftCardList', function() {
    it('should create an instance of ModelResponseCartGiftCardList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCartGiftCardList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCartGiftCardList);
    });
