...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductChildItemCombination();
  });
  ...
  describe('ProductChildItemCombination', function() {
    it('should create an instance of ProductChildItemCombination', function() {
      ...
      //var instance = new Api2CartOpenApi.ProductChildItemCombination();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductChildItemCombination);
    });
