...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductReviewListResult();
  });
  ...
  describe('ResponseProductReviewListResult', function() {
    it('should create an instance of ResponseProductReviewListResult', function() {
      // uncomment below and update the code to test ResponseProductReviewListResult
      //var instance = new Api2CartOpenApi.ResponseProductReviewListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductReviewListResult);
    });
