...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductUpdateBatch();
  });
  ...
  describe('ProductUpdateBatch', function() {
    it('should create an instance of ProductUpdateBatch', function() {
      // uncomment below and update the code to test ProductUpdateBatch
      //var instance = new Api2CartOpenApi.ProductUpdateBatch();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductUpdateBatch);
    });
