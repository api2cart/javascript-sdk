...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCustomerList();
  });
  ...
  describe('ModelResponseCustomerList', function() {
    it('should create an instance of ModelResponseCustomerList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCustomerList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCustomerList);
    });
