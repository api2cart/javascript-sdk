...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCartShippingZonesList();
  });
  ...
  describe('ModelResponseCartShippingZonesList', function() {
    it('should create an instance of ModelResponseCartShippingZonesList', function() {
      // uncomment below and update the code to test ModelResponseCartShippingZonesList
      //var instance = new Api2CartOpenApi.ModelResponseCartShippingZonesList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCartShippingZonesList);
    });
