...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseReturnListResult();
  });
  ...
  describe('ResponseReturnListResult', function() {
    it('should create an instance of ResponseReturnListResult', function() {
      // uncomment below and update the code to test ResponseReturnListResult
      //var instance = new Api2CartOpenApi.ResponseReturnListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseReturnListResult);
    });
