...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.CustomerWishList();
  });
  ...
  describe('CustomerWishList', function() {
    it('should create an instance of CustomerWishList', function() {
      ...
      //var instance = new Api2CartOpenApi.CustomerWishList();
      //expect(instance).to.be.a(Api2CartOpenApi.CustomerWishList);
    });
