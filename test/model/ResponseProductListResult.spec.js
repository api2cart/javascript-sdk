...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductListResult();
  });
  ...
  describe('ResponseProductListResult', function() {
    it('should create an instance of ResponseProductListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseProductListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductListResult);
    });
