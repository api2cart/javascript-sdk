...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseCartCouponListResult();
  });
  ...
  describe('ResponseCartCouponListResult', function() {
    it('should create an instance of ResponseCartCouponListResult', function() {
      ...
      //var instance = new Api2CartOpenApi.ResponseCartCouponListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseCartCouponListResult);
    });
