...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductVariantAddBatch();
  });
  ...
  describe('ProductVariantAddBatch', function() {
    it('should create an instance of ProductVariantAddBatch', function() {
      // uncomment below and update the code to test ProductVariantAddBatch
      //var instance = new Api2CartOpenApi.ProductVariantAddBatch();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductVariantAddBatch);
    });
