...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseMarketplaceProductFind();
  });
  ...
  describe('ModelResponseMarketplaceProductFind', function() {
    it('should create an instance of ModelResponseMarketplaceProductFind', function() {
      // uncomment below and update the code to test ModelResponseMarketplaceProductFind
      //var instance = new Api2CartOpenApi.ModelResponseMarketplaceProductFind();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseMarketplaceProductFind);
    });
