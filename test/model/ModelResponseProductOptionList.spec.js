...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseProductOptionList();
  });
  ...
  describe('ModelResponseProductOptionList', function() {
    it('should create an instance of ModelResponseProductOptionList', function() {
      // uncomment below and update the code to test ModelResponseProductOptionList
      //var instance = new Api2CartOpenApi.ModelResponseProductOptionList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseProductOptionList);
    });
