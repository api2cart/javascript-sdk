...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.TaxClassCountries();
  });
  ...
  describe('TaxClassCountries', function() {
    it('should create an instance of TaxClassCountries', function() {
      ...
      //var instance = new Api2CartOpenApi.TaxClassCountries();
      //expect(instance).to.be.a(Api2CartOpenApi.TaxClassCountries);
    });
