...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCartMetaDataList();
  });
  ...
  describe('ModelResponseCartMetaDataList', function() {
    it('should create an instance of ModelResponseCartMetaDataList', function() {
      ...
      //var instance = new Api2CartOpenApi.ModelResponseCartMetaDataList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCartMetaDataList);
    });
