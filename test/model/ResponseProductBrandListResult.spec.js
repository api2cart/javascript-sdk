...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ResponseProductBrandListResult();
  });
  ...
  describe('ResponseProductBrandListResult', function() {
    it('should create an instance of ResponseProductBrandListResult', function() {
      // uncomment below and update the code to test ResponseProductBrandListResult
      //var instance = new Api2CartOpenApi.ResponseProductBrandListResult();
      //expect(instance).to.be.a(Api2CartOpenApi.ResponseProductBrandListResult);
    });
