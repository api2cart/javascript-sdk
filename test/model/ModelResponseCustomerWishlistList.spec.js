...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ModelResponseCustomerWishlistList();
  });
  ...
  describe('ModelResponseCustomerWishlistList', function() {
    it('should create an instance of ModelResponseCustomerWishlistList', function() {
      // uncomment below and update the code to test ModelResponseCustomerWishlistList
      //var instance = new Api2CartOpenApi.ModelResponseCustomerWishlistList();
      //expect(instance).to.be.a(Api2CartOpenApi.ModelResponseCustomerWishlistList);
    });
