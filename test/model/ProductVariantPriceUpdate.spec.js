...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.ProductVariantPriceUpdate();
  });
  ...
  describe('ProductVariantPriceUpdate', function() {
    it('should create an instance of ProductVariantPriceUpdate', function() {
      ...
      //var instance = new Api2CartOpenApi.ProductVariantPriceUpdate();
      //expect(instance).to.be.a(Api2CartOpenApi.ProductVariantPriceUpdate);
    });
