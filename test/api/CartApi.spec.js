...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.CartApi();
  });
  ...
  describe('CartApi', function() {
    ...
    describe('cartGiftcardDelete', function() {
      it('should call cartGiftcardDelete successfully', function(done) {
        //uncomment below and update the code to test cartGiftcardDelete
        //instance.cartGiftcardDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
