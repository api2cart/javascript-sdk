...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2CartOpenApi.OrderApi();
  });
  ...
  describe('OrderApi', function() {
    ...
    describe('orderReturnAdd', function() {
      it('should call orderReturnAdd successfully', function(done) {
        //uncomment below and update the code to test orderReturnAdd
        //instance.orderReturnAdd(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('orderReturnDelete', function() {
      it('should call orderReturnDelete successfully', function(done) {
        //uncomment below and update the code to test orderReturnDelete
        //instance.orderReturnDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('orderReturnUpdate', function() {
      it('should call orderReturnUpdate successfully', function(done) {
        //uncomment below and update the code to test orderReturnUpdate
        //instance.orderReturnUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('orderShipmentAddBatch', function() {
      it('should call orderShipmentAddBatch successfully', function(done) {
        //uncomment below and update the code to test orderShipmentAddBatch
        //instance.orderShipmentAddBatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
