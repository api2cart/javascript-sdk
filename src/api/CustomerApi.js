...
export default class CustomerApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the customerAddressAdd operation.
     * @callback module:api/CustomerApi~customerAddressAddCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/CustomerAddressAdd} customerAddressAdd 
     * @param {module:api/CustomerApi~customerAddressAddCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AttributeAdd200Response}
     */
    customerAddressAdd(customerAddressAdd, callback) {
      let postBody = customerAddressAdd;
      // verify the required parameter 'customerAddressAdd' is set
      if (customerAddressAdd === undefined || customerAddressAdd === null) {
        throw new Error("Missing the required parameter 'customerAddressAdd' when calling customerAddressAdd");
      }
      ...
      return this.apiClient.callApi(
        '/customer.address.add.json', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the customerDelete operation.
     * @callback module:api/CustomerApi~customerDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} id Identifies customer specified by the id
     * @param {module:api/CustomerApi~customerDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomerDelete200Response}
     */
    customerDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling customerDelete");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ModelResponseCustomerWishlistList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    customerWishlistList(customerId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ModelResponseCustomerWishlistList;
      return this.apiClient.callApi(
