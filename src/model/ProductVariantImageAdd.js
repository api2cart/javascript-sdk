...
class ProductVariantImageAdd {
     ...
     * @param productVariantId {String} Defines product's variants specified by variant id
     ...
     */
    constructor(productVariantId, imageName, type) { 
        
        ProductVariantImageAdd.initialize(this, productVariantId, imageName, type);
    }
     ...
     */
    static initialize(obj, productVariantId, imageName, type) { 
...
ProductVariantImageAdd.RequiredProperties = ["product_variant_id", "image_name", "type"];
