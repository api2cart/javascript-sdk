...
class ProductImageAdd {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('option_value_ids')) {
                obj['option_value_ids'] = ApiClient.convertToType(data['option_value_ids'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['option_value_ids'] && !(typeof data['option_value_ids'] === 'string' || data['option_value_ids'] instanceof String)) {
            throw new Error("Expected the field `option_value_ids` to be a primitive type in the JSON string but got " + data['option_value_ids']);
        }
        // ensure the json data is a string
 ...
 * @member {String} option_value_ids
 */
ProductImageAdd.prototype['option_value_ids'] = undefined;
 ...
 * @member {Boolean} use_latest_api_version
 * @default false
 */
ProductImageAdd.prototype['use_latest_api_version'] = false;
