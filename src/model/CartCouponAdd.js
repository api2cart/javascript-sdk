...
class CartCouponAdd {
     ...
     */
    constructor(code, actionType, actionApplyTo, actionScope, actionAmount) { 
        
        CartCouponAdd.initialize(this, code, actionType, actionApplyTo, actionScope, actionAmount);
    }
     ...
     */
    static initialize(obj, code, actionType, actionApplyTo, actionScope, actionAmount) { 
        obj['code'] = code;
