...
class OrderAdd {
     ...
     */
    constructor(orderStatus, customerEmail, billFirstName, billLastName, billAddress1, billCity, billPostcode, billState, billCountry, orderItem) { 
        
        OrderAdd.initialize(this, orderStatus, customerEmail, billFirstName, billLastName, billAddress1, billCity, billPostcode, billState, billCountry, orderItem);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('customer_country')) {
                obj['customer_country'] = ApiClient.convertToType(data['customer_country'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['customer_country'] && !(typeof data['customer_country'] === 'string' || data['customer_country'] instanceof String)) {
            throw new Error("Expected the field `customer_country` to be a primitive type in the JSON string but got " + data['customer_country']);
        }
        // ensure the json data is a string
...
OrderAdd.RequiredProperties = ["order_status", "customer_email", "bill_first_name", "bill_last_name", "bill_address_1", "bill_city", "bill_postcode", "bill_state", "bill_country", "order_item"];
 ...
 */
OrderAdd.prototype['customer_country'] = undefined;
