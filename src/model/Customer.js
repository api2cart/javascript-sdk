    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('consents')) {
                obj['consents'] = ApiClient.convertToType(data['consents'], [CustomerConsent]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['consents']) { // data not null
            ...
            for (const item of data['consents']) {
                CustomerConsent.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
/**
 * @member {Array.<module:model/CustomerConsent>} consents
 */
Customer.prototype['consents'] = undefined;
