...
class Shipment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('delivered_at')) {
                obj['delivered_at'] = A2CDateTime.constructFromObject(data['delivered_at']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `delivered_at`
        if (data['delivered_at']) { // data not null
          A2CDateTime.validateJSON(data['delivered_at']);
        }
...
/**
 * @member {module:model/A2CDateTime} delivered_at
 */
Shipment.prototype['delivered_at'] = undefined;
