...
class OrderRefundAdd200ResponseResult {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additional_refund_ids')) {
                obj['additional_refund_ids'] = ApiClient.convertToType(data['additional_refund_ids'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['additional_refund_ids'] && !(typeof data['additional_refund_ids'] === 'string' || data['additional_refund_ids'] instanceof String)) {
            throw new Error("Expected the field `additional_refund_ids` to be a primitive type in the JSON string but got " + data['additional_refund_ids']);
        }
...
/**
 * @member {String} additional_refund_ids
 */
OrderRefundAdd200ResponseResult.prototype['additional_refund_ids'] = undefined;
